...
export default function FixedAssetsPage() {
  ...
  const [depreciationMode, setDepreciationMode] = useState("monthly");
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      const [categoriesResponse, banksResponse, assetsResponse, depreciationResponse] = await Promise.all([
        ...
        api.get(`/fixed-assets/depreciations?year=${runPeriod.year}${depreciationMode === "monthly" ? `&month=${runPeriod.month}` : ""}`),
      ]);
  ...
  }, [runPeriod.year, runPeriod.month, depreciationMode]);
