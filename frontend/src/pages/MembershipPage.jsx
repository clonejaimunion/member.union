...
import { ArrowRight, BarChart3, Edit3, FileUp, Home, LogOut, Printer, Save, Search, Trash2, UserRoundPlus, UsersRound, X } from "lucide-react";
...
export default function MembershipPage() {
  ...
  const createMember = async (event) => {
    ...
    try {
      if (editingMemberId) {
        const response = await api.put(`/memberships/${editingMemberId}`, form);
